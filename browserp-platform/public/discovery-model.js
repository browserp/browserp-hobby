(() => {
  ...
  const taxonomy = {
    fivem: { modeLabel: "Framework", modeAny: "Any framework", modes: [
      ...
      ["serious rp", "Serious RP", "serious roleplay", "seriousrp", "seriousroleplay"], ["semi serious rp", "Semi-serious RP", "semi serious roleplay", "semiserious", "semi serious"], ["custom cars", "Custom cars", "custom vehicles", "customcars", "customvehicles"], ["economy", "Economy", "economy rp"], ["police rp", "Police RP", "police", "law enforcement", "leo", "police roleplay"], ["ems", "EMS", "medical rp", "emergency medical services"], ["civilian life", "Civilian life", "civilian rp"], ["player owned businesses", "Player-owned businesses", "player businesses", "playerownedbusinesses"], ["housing", "Housing", "player housing"], ["custom maps", "Custom maps", "custom interiors", "mlo", "mlos"], ["racing", "Racing"], ["public safety", "Public safety"]
    ] },
