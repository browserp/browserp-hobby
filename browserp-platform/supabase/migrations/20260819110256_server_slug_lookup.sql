-- Exact clean-route lookup added without removing the live v1.2.2 overload.
begin;
...
revoke execute on function public.search_server_directory(text,text,text,text,boolean,boolean,boolean,text,integer)
  from public;
grant execute on function public.search_server_directory(text,text,text,text,boolean,boolean,boolean,text,integer)
  to anon, authenticated;
comment on function public.search_server_directory(text,text,text,text,boolean,boolean,boolean,text,integer)
  is 'Public safe directory search with optional exact slug lookup for /server/:slug.';
